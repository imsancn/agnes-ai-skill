...
### ⚠️ Agnes-2.0-Flash 上下文窗口升级说明（2026-06-22 更新）
...
### 11.1 Yacey 的 Agnes AI 生成 Skill（推荐 Agent 用户）
...
### 11.2 kangarooking 的免费模型 Skills（推荐 Codex 用户）
...
### 11.3 16nic 的 ComfyUI 节点（推荐 ComfyUI 用户）
...
### 12.2 OpenAI Codex CLI 配置（命令行用户）
...
## 15. Claude CLI 接入指南（通过 CC-Switch）
...
## 16. Claude Desktop 接入指南（通过 CC-Switch）
