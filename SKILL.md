...
> **当前规格：** Agnes-2.0-Flash 上下文窗口参考值为 **512K**，Max Output **64K**。此前曾短暂开放 1M 后因稳定性回退，近期已升级至 512K。具体规格以 [官方 MODEL_CATALOG.md](https://github.com/AgnesAI-Labs/Agnes-AI/blob/main/MODEL_CATALOG.md) 为准。
>
> - Context：512K（参考值，1M 曾回退）
> - Max Output：64K
>
