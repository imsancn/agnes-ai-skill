# Agnes AI Skill — Token Plan 优化版

> Agnes AI，让世界级 AI 属于每一个人。

本仓库包含交互式接入助手、完整 API 文档、以及通用支持 Skill，帮助开发者快速接入 Agnes AI 全模态 API（文本、图像、视频）。
...
|------|------|-----------|------|-----|
| 月费 | $0 | $4 | $10 | $50 |
| 文本 RPM | 20 | 1,000 | 1,000 | 1,000 |
| 图像 1K RPM | 20 | 100 | 100 | 100 |
| 图像 2K RPM | 10 | 80 | 80 | 80 |
| 视频 RPM | 1 | 5 | 5 | 5 |
| 文本配额 | 无限 | 1,500 次/5h | 7,500 次/5h | 30,000 次/5h |
| 图像配额 | 无限 | 4,000 张/天 | 4,000 张/天 | 4,000 张/天 |
| 视频配额 | 无限 | 500 秒/天 | 500 秒/天 | 500 秒/天 |

> ⭐ **Starter 推荐个人用户**：$4/月，文本 RPM 50 倍提升（20→1,000），视频 RPM 5，1,500 请求/5小时。数据引用自 <a href="https://github.com/AgnesAI-Labs/Agnes-AI/blob/main/docs/TOKEN_PLAN_FAQ.md" target="_blank">官方 TOKEN_PLAN_FAQ</a>。
